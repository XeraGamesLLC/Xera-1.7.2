...
- **Auth:** Discord-shaped tokens (userId + tokenVersion + HMAC, no expiry, invalidated by logout or password reset - not JWT access/refresh rotation), argon2id password hashing
