...
import dev.xera.client.impl.event.impl.move.EventBlockPushEntity;
import dev.xera.client.impl.event.impl.move.EventSlowdown;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onLivingUpdate()
    {
        if (this.equals(mc.thePlayer)) {
            XeraClient.BUS.post(new EventUpdate());
        }
        ...
        else
        {
            ...
            if (this.isUsingItem() && !this.isRiding())
            {
                ...
                XeraClient.BUS.post(new EventSlowdown(movementInput));
            }
    ...
    {
        if (XeraClient.BUS.post(new EventBlockPushEntity(this))) {
            return false;
        }
