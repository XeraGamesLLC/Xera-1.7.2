...
import dev.xera.client.impl.event.impl.client.EventAddChatMessage;
import dev.xera.client.impl.module.miscellaneous.Translator;
...
public class GuiNewChat extends Gui
{
    ...
    public void printChatMessageWithOptionalDeletion(IChatComponent p_146234_1_, int p_146234_2_)
    {
        ...
        if (XeraClient.BUS.post(new EventAddChatMessage(p_146234_1_, p_146234_2_))) {
            return;
        }
    ...
    {
        if (!this.getChatOpen() && !XeraClient.getInstance().getModuleManager().getModule(Translator.class).isRunning())
        {
            return null;
        }
        else
