...
import dev.xera.client.impl.account.gui.GuiAccountLoginScreen;
...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        String var9 = "Xera Client " + XeraClient.VERSION.getVersionString() + " for MC 1.7.2";
