...
import dev.xera.client.impl.module.miscellaneous.AutoReconnect;
...
public class GuiDisconnected extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        AutoReconnect autoReconnect = XeraClient.getInstance().getModuleManager().getModule(AutoReconnect.class);
