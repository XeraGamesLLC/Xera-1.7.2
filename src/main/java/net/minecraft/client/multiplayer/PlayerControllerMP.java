...
import dev.xera.client.impl.event.impl.player.EventAttack;
...
import dev.xera.client.impl.event.impl.world.EventRightClickBlock;
...
public class PlayerControllerMP
{
    ...
    {
        if (XeraClient.BUS.post(new EventClickBlock(par1, par2, par3, par4))) {
            return;
        }
    ...
    {
        if (XeraClient.BUS.post(new EventRightClickBlock(par4, par5, par6, par7, par8Vec3, par3ItemStack))) {
            return false;
        }
    ...
    public void attackEntity(EntityPlayer par1EntityPlayer, Entity par2Entity)
    {
        if (par1EntityPlayer.equals(mc.thePlayer)) {
            if (XeraClient.BUS.post(new EventAttack(par2Entity))) {
                return;
            }
        }
