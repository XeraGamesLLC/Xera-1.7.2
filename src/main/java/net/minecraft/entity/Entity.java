...
import dev.xera.client.impl.event.impl.move.EventEntityCollision;
import dev.xera.client.impl.event.impl.move.EventMotion;
import dev.xera.client.impl.event.impl.move.EventSafeWalk;
import dev.xera.client.impl.event.impl.move.EventStep;
import dev.xera.client.impl.event.impl.player.EventPlayerTurn;
...
public abstract class Entity
{
    ...
    public void moveEntity(double par1, double par3, double par5)
    {
        ...
        else
        {
            ...
            XeraClient.BUS.post(safewalkEvent);
            ...
            XeraClient.BUS.post(new EventStep(this, boundingBox));
    ...
    {
        if (XeraClient.BUS.post(new EventEntityCollision(this, par1Entity))) {
            return;
        }
