...
import dev.xera.client.impl.event.impl.world.EventAddBox;
import dev.xera.client.impl.event.impl.world.EventGetBox;
...
public class Block
{
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(World p_149633_1_, int p_149633_2_, int p_149633_3_, int p_149633_4_)
    {
        ...
        return XeraClient.BUS.post(event) ? event.getBox() : bb;
    }
