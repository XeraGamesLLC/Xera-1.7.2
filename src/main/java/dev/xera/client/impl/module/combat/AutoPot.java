...
import dev.xera.client.impl.module.world.Scaffold;
...
import dev.xera.client.utils.world.RayTraceUtils;
...
public class AutoPot extends ToggleableModule {
    ...
    public void onMotionUpdate(EventMotionUpdate event) {
        ...
        if (Aura.attacking || XeraClient.getInstance().getModuleManager().getModule(Scaffold.class).isRunning()) {
            return;
        }
