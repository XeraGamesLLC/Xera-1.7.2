...
import dev.xera.client.impl.event.impl.render.EventRenderHand;
...
import dev.xera.client.utils.render.shader.impl.FillShader;
...
public class Shader extends ToggleableModule {
    ...
    public void onRenderWorld(EventRender3D event) {
        ...
        dev.xera.client.utils.render.shader.Shader shader = null;
