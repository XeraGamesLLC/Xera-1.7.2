...
public class TargetStrafe extends ToggleableModule {
    ...
    public static boolean isMoving() {
        ...
        //	at dev.xera.client.impl.module.movement.TargetStrafe.isMoving(TargetStrafe.java:54)
        //	at dev.xera.client.impl.module.movement.Speed.onMotion(Speed.java:67)
