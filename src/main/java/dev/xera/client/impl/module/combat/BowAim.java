...
import dev.xera.client.impl.module.visuals.Trajectories;
...
public class BowAim extends ToggleableModule {
    ...
    private boolean isValidTarget(EntityLivingBase e) {
        ...
        return !XeraClient.getInstance().getModuleManager().getModule(FreeCamera.class).isRunning() || e.getEntityId() != -133769420;
    }
