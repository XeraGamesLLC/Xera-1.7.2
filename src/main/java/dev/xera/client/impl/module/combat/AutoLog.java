...
import dev.xera.client.impl.command.impl.FakePlayer;
import dev.xera.client.impl.event.impl.client.EventTick;
import dev.xera.client.impl.event.impl.world.EventEntitySpawn;
import dev.xera.client.impl.module.ModuleCategory;
import dev.xera.client.impl.module.ToggleableModule;
import dev.xera.client.impl.module.active.Notifications;
...
public class AutoLog extends ToggleableModule {
    ...
    public void onEntitySpawn(EventEntitySpawn event) {
        if (event.getEntity() instanceof EntityPlayer) {
            ...
            if (XeraClient.getInstance().getModuleManager().getModule(FreeCamera.class).isRunning() && player.getEntityId() == -133769420) {
                return;
            }
            ...
            if (visualRange.getValue() && !XeraClient.getInstance().getFriendManager().isFriend(player)) {
