...
public class CapeManager {
    public static final ResourceLocation CAPE_RESOURCE = new ResourceLocation("xera/textures/capes/beta_cape.png");
    ...
    public CapeManager() {
        fetch();
        XeraClient.LOGGER.info("Loaded {} cape users", capeUserNames.size());
    }
