...
import dev.xera.client.impl.waypoint.Waypoint;
...
public class Waypoints extends Command {
    ...
    public String dispatch(CommandContext ctx) {
        ...
        List<Waypoint> waypoints = XeraClient.getInstance().getWaypointManager().get(ip);
        ...
        switch (action.toLowerCase()) {
            ...
            case "add": {
                ...
                XeraClient.getInstance().getWaypointManager().add(
                        ip,
            ...
            case "-": {
                ...
                return XeraClient.getInstance().getWaypointManager().remove(ip, name)
