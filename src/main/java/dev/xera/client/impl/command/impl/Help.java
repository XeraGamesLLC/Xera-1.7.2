...
public class Help extends Command {
    ...
    public String dispatch(CommandContext ctx) {
        ...
        if (name != null && !name.isEmpty()) {
            Command command = XeraClient.getInstance().getCommandManager().commandNameMap.getOrDefault(name.trim().toLowerCase(), null);
            if (command != null) {
        ...
        List<Command> commandList = XeraClient.getInstance().getCommandManager().getRegistry();
